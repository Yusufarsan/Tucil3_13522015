...
public class Asearch {
    public List<String> aStarSearch(String start,String goal,List<String> dictionary) {
        ...
        PriorityQueue<String> frontier = new PriorityQueue<>(new Comparator<String>() {
            ...
            public int compare(String o1, String o2) {
                return Integer.compare(Util.fn(start, o1, goal), Util.fn(start, o2, goal));
            }
        });
        ...
        while (!frontier.isEmpty()) {
            ...
            for (String word : dictionary) {
                if (word.length() == start.length() && !explored.contains(word) && Util.isOneLetterDifferent(current, word)) {
                    frontier.add(word);
